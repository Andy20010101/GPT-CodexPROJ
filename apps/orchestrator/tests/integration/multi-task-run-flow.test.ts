...
describe('multi-task runtime flow', () => {
  it('unlocks dependent tasks and auto-runs release review when predecessors are accepted', async () => {
  ...
  it('keeps the run in release_review when release review requests changes', async () => {

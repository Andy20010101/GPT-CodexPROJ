...
- target phase: `<continued_preparation | requirement_freeze | architecture_freeze | task_graph_planning | fresh_run>`

Frozen Content:
- direction: `<frozen direction summary>`
- scope: `<frozen scope summary>`
- boundary: `<frozen boundary summary>`
- success/evidence: `<frozen success and evidence summary>`
- workstreams: `<frozen workstream summary>`

Not Frozen:
- `<non-blocking unresolved item or carried risk>`
- `<another unresolved but non-blocking item>`

Next Objective:
- `<single downstream objective>`

Do Not Reopen:
- `<frozen argument or expansion that should stay closed>`
- `<another frozen boundary that should not be reopened>`

Priority Read Files:
- `<highest-priority packet file>`
- `<second-highest-priority packet file>`

Constraints:
- `<hard boundary or guardrail>`
- `<another hard boundary or guardrail>`
```
